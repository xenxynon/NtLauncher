...
.method public static g(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1}, Lo5/e0;->a(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static varargs h([Ln5/k;)Ljava/util/Map;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    invoke-static {v1}, Lo5/d0;->b(I)I

    move-result v1

    invoke-direct {v0, v1}, Ljava/util/LinkedHashMap;-><init>(I)V

    invoke-static {p0, v0}, Lo5/g0;->o([Ln5/k;Ljava/util/Map;)Ljava/util/Map;
...
.method public static final i(Ljava/util/Map;)Ljava/util/Map;
    ...
    :cond_0
    invoke-static {p0}, Lo5/f0;->d(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final k(Ljava/util/Map;[Ln5/k;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
...
.method public static l(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lo5/g0;->m(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lo5/d0;->c(Ln5/k;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lo5/g0;->m(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    move-result-object p0

    invoke-static {p0}, Lo5/g0;->i(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final m(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p1, p0}, Lo5/g0;->j(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static n(Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lo5/d0;->p(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final o([Ln5/k;Ljava/util/Map;)Ljava/util/Map;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    invoke-static {p1, p0}, Lo5/g0;->k(Ljava/util/Map;[Ln5/k;)V
