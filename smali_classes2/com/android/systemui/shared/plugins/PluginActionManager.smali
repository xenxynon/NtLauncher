...
# direct methods
.method private constructor <init>(Landroid/content/Context;Landroid/content/pm/PackageManager;Ljava/lang/String;Li0/f;Ljava/lang/Class;ZLjava/util/concurrent/Executor;Ljava/util/concurrent/Executor;ZLandroid/app/NotificationManager;Lcom/android/systemui/shared/plugins/PluginEnabler;Ljava/util/List;Lcom/android/systemui/shared/plugins/PluginInstance$Factory;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p4, p0, Lcom/android/systemui/shared/plugins/PluginActionManager;->mListener:Li0/f;
...
.method synthetic constructor <init>(Landroid/content/Context;Landroid/content/pm/PackageManager;Ljava/lang/String;Li0/f;Ljava/lang/Class;ZLjava/util/concurrent/Executor;Ljava/util/concurrent/Executor;ZLandroid/app/NotificationManager;Lcom/android/systemui/shared/plugins/PluginEnabler;Ljava/util/List;Lcom/android/systemui/shared/plugins/PluginInstance$Factory;Lcom/android/systemui/shared/plugins/PluginActionManager$1;)V
    .locals 0
...
.method public static synthetic d(Lcom/android/systemui/shared/plugins/PluginActionManager;Ljava/lang/String;)V
    .locals 0
...
.method public static synthetic e(Lcom/android/systemui/shared/plugins/PluginActionManager;Lcom/android/systemui/shared/plugins/PluginInstance;)V
    .locals 0
...
.method public static synthetic f(Lcom/android/systemui/shared/plugins/PluginActionManager;Ljava/lang/String;)V
    .locals 0
...
.method public static synthetic g(Lcom/android/systemui/shared/plugins/PluginActionManager;)V
    .locals 0
...
.method private handleQueryPlugins(Ljava/lang/String;)V
    ...
    new-instance v2, Lcom/android/systemui/shared/plugins/c;

    invoke-direct {v2, p0, v0}, Lcom/android/systemui/shared/plugins/c;-><init>(Lcom/android/systemui/shared/plugins/PluginActionManager;Lcom/android/systemui/shared/plugins/PluginInstance;)V
...
.method private loadPluginComponent(Landroid/content/ComponentName;)Lcom/android/systemui/shared/plugins/PluginInstance;
    ...
    iget-object v10, p0, Lcom/android/systemui/shared/plugins/PluginActionManager;->mListener:Li0/f;

    move-object v8, p1

    invoke-virtual/range {v5 .. v10}, Lcom/android/systemui/shared/plugins/PluginInstance$Factory;->create(Landroid/content/Context;Landroid/content/pm/ApplicationInfo;Landroid/content/ComponentName;Ljava/lang/Class;Li0/f;)Lcom/android/systemui/shared/plugins/PluginInstance;
    ...
    invoke-direct {p0, p1, v3, v0}, Lcom/android/systemui/shared/plugins/PluginActionManager;->reportInvalidVersion(Landroid/content/ComponentName;Ljava/lang/String;Lcom/android/systemui/shared/plugins/VersionInfo$InvalidVersionException;)V
    :try_end_2
...
.method private queryAll()V
    ...
    invoke-direct {v3, p0, v1}, Lcom/android/systemui/shared/plugins/b;-><init>(Lcom/android/systemui/shared/plugins/PluginActionManager;Lcom/android/systemui/shared/plugins/PluginInstance;)V
...
.method private removePkg(Ljava/lang/String;)V
    ...
    new-instance v3, Lcom/android/systemui/shared/plugins/e;

    invoke-direct {v3, p0, v1}, Lcom/android/systemui/shared/plugins/e;-><init>(Lcom/android/systemui/shared/plugins/PluginActionManager;Lcom/android/systemui/shared/plugins/PluginInstance;)V
...
.method dependsOn(Li0/d;Ljava/lang/Class;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<C:",
...
.method public destroy()V
    ...
    new-instance v3, Lcom/android/systemui/shared/plugins/d;

    invoke-direct {v3, p0, v1}, Lcom/android/systemui/shared/plugins/d;-><init>(Lcom/android/systemui/shared/plugins/PluginActionManager;Lcom/android/systemui/shared/plugins/PluginInstance;)V
...
.method public loadAll()V
    ...
    invoke-direct {v1, p0}, Lcom/android/systemui/shared/plugins/a;-><init>(Lcom/android/systemui/shared/plugins/PluginActionManager;)V
...
.method public onPackageRemoved(Ljava/lang/String;)V
    ...
    new-instance v1, Lcom/android/systemui/shared/plugins/f;

    invoke-direct {v1, p0, p1}, Lcom/android/systemui/shared/plugins/f;-><init>(Lcom/android/systemui/shared/plugins/PluginActionManager;Ljava/lang/String;)V
...
.method public reloadPackage(Ljava/lang/String;)V
    ...
    new-instance v1, Lcom/android/systemui/shared/plugins/g;

    invoke-direct {v1, p0, p1}, Lcom/android/systemui/shared/plugins/g;-><init>(Lcom/android/systemui/shared/plugins/PluginActionManager;Ljava/lang/String;)V
