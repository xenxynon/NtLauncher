...
.method static synthetic access$18800()Lcom/android/launcher3/logger/LauncherAtom$Task;
    .locals 1
...
.method static synthetic access$19200(Lcom/android/launcher3/logger/LauncherAtom$Task;Ljava/lang/String;)V
    .locals 0
...
.method static synthetic access$19500(Lcom/android/launcher3/logger/LauncherAtom$Task;I)V
    .locals 0
...
.method protected final dynamicMethod(Lt1/k$i;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :pswitch_0
    sget-object p0, Lcom/android/launcher3/logger/LauncherAtom$Task;->PARSER:Lt1/u;

    if-nez p0, :cond_1

    const-class p0, Lcom/android/launcher3/logger/LauncherAtom$Task;

    monitor-enter p0

    :try_start_0
    sget-object p1, Lcom/android/launcher3/logger/LauncherAtom$Task;->PARSER:Lt1/u;
    ...
    sput-object p1, Lcom/android/launcher3/logger/LauncherAtom$Task;->PARSER:Lt1/u;
    ...
    :cond_3
    iget p3, p0, Lcom/android/launcher3/logger/LauncherAtom$Task;->bitField0_:I

    or-int/lit8 p3, p3, 0x4

    iput p3, p0, Lcom/android/launcher3/logger/LauncherAtom$Task;->bitField0_:I

    invoke-virtual {p2}, Lt1/f;->o()I

    move-result p3

    iput p3, p0, Lcom/android/launcher3/logger/LauncherAtom$Task;->index_:I
    ...
    iput-object p3, p0, Lcom/android/launcher3/logger/LauncherAtom$Task;->componentName_:Ljava/lang/String;
    ...
    iput-object p3, p0, Lcom/android/launcher3/logger/LauncherAtom$Task;->packageName_:Ljava/lang/String;
    :try_end_1
    ...
    check-cast p3, Lcom/android/launcher3/logger/LauncherAtom$Task;
    ...
    invoke-virtual {p3}, Lcom/android/launcher3/logger/LauncherAtom$Task;->hasPackageName()Z

    move-result v1

    iget-object v2, p3, Lcom/android/launcher3/logger/LauncherAtom$Task;->packageName_:Ljava/lang/String;
    ...
    invoke-virtual {p3}, Lcom/android/launcher3/logger/LauncherAtom$Task;->hasComponentName()Z

    move-result v1

    iget-object v2, p3, Lcom/android/launcher3/logger/LauncherAtom$Task;->componentName_:Ljava/lang/String;
    ...
    invoke-virtual {p3}, Lcom/android/launcher3/logger/LauncherAtom$Task;->hasIndex()Z

    move-result v1

    iget v2, p3, Lcom/android/launcher3/logger/LauncherAtom$Task;->index_:I
    ...
    iget p2, p3, Lcom/android/launcher3/logger/LauncherAtom$Task;->bitField0_:I
    ...
    invoke-direct {p0, v0}, Lcom/android/launcher3/logger/LauncherAtom$Task$Builder;-><init>(Lcom/android/launcher3/logger/LauncherAtom$1;)V
...
.method public getSerializedSize()I
    ...
    iget v2, p0, Lcom/android/launcher3/logger/LauncherAtom$Task;->index_:I
...
.method public writeTo(Lt1/g;)V
    ...
    iget v1, p0, Lcom/android/launcher3/logger/LauncherAtom$Task;->index_:I
