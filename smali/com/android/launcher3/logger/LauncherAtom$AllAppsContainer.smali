...
.method static synthetic access$11000()Lcom/android/launcher3/logger/LauncherAtom$AllAppsContainer;
    .locals 1
...
.method static synthetic access$11300(Lcom/android/launcher3/logger/LauncherAtom$AllAppsContainer;Lcom/android/launcher3/logger/LauncherAtom$TaskBarContainer$Builder;)V
    .locals 0
...
.method protected final dynamicMethod(Lt1/k$i;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :pswitch_0
    sget-object p0, Lcom/android/launcher3/logger/LauncherAtom$AllAppsContainer;->PARSER:Lt1/u;

    if-nez p0, :cond_1

    const-class p0, Lcom/android/launcher3/logger/LauncherAtom$AllAppsContainer;

    monitor-enter p0

    :try_start_0
    sget-object p1, Lcom/android/launcher3/logger/LauncherAtom$AllAppsContainer;->PARSER:Lt1/u;
    ...
    sput-object p1, Lcom/android/launcher3/logger/LauncherAtom$AllAppsContainer;->PARSER:Lt1/u;
    ...
    :cond_3
    iget p1, p0, Lcom/android/launcher3/logger/LauncherAtom$AllAppsContainer;->parentContainerCase_:I

    if-ne p1, v2, :cond_4

    iget-object p1, p0, Lcom/android/launcher3/logger/LauncherAtom$AllAppsContainer;->parentContainer_:Ljava/lang/Object;
    ...
    iput-object v3, p0, Lcom/android/launcher3/logger/LauncherAtom$AllAppsContainer;->parentContainer_:Ljava/lang/Object;
    ...
    :cond_5
    iput v2, p0, Lcom/android/launcher3/logger/LauncherAtom$AllAppsContainer;->parentContainerCase_:I
    :try_end_1
    ...
    check-cast p3, Lcom/android/launcher3/logger/LauncherAtom$AllAppsContainer;

    sget-object p1, Lcom/android/launcher3/logger/LauncherAtom$1;->$SwitchMap$com$android$launcher3$logger$LauncherAtom$AllAppsContainer$ParentContainerCase:[I

    invoke-virtual {p3}, Lcom/android/launcher3/logger/LauncherAtom$AllAppsContainer;->getParentContainerCase()Lcom/android/launcher3/logger/LauncherAtom$AllAppsContainer$ParentContainerCase;
    ...
    iget-object v1, p3, Lcom/android/launcher3/logger/LauncherAtom$AllAppsContainer;->parentContainer_:Ljava/lang/Object;
    ...
    iget p1, p3, Lcom/android/launcher3/logger/LauncherAtom$AllAppsContainer;->parentContainerCase_:I
    ...
    :cond_c
    iget p1, p0, Lcom/android/launcher3/logger/LauncherAtom$AllAppsContainer;->bitField0_:I

    iget p2, p3, Lcom/android/launcher3/logger/LauncherAtom$AllAppsContainer;->bitField0_:I

    or-int/2addr p1, p2

    iput p1, p0, Lcom/android/launcher3/logger/LauncherAtom$AllAppsContainer;->bitField0_:I
    ...
    invoke-direct {p0, v1}, Lcom/android/launcher3/logger/LauncherAtom$AllAppsContainer$Builder;-><init>(Lcom/android/launcher3/logger/LauncherAtom$1;)V
...
.method public getSerializedSize()I
    ...
    iget v1, p0, Lcom/android/launcher3/logger/LauncherAtom$AllAppsContainer;->parentContainerCase_:I

    const/4 v2, 0x1

    if-ne v1, v2, :cond_1

    iget-object v1, p0, Lcom/android/launcher3/logger/LauncherAtom$AllAppsContainer;->parentContainer_:Ljava/lang/Object;
