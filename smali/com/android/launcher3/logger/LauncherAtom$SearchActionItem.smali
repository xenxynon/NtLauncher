...
.method static synthetic access$21400()Lcom/android/launcher3/logger/LauncherAtom$SearchActionItem;
    .locals 1
...
.method protected final dynamicMethod(Lt1/k$i;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :pswitch_0
    sget-object p0, Lcom/android/launcher3/logger/LauncherAtom$SearchActionItem;->PARSER:Lt1/u;

    if-nez p0, :cond_1

    const-class p0, Lcom/android/launcher3/logger/LauncherAtom$SearchActionItem;

    monitor-enter p0

    :try_start_0
    sget-object p1, Lcom/android/launcher3/logger/LauncherAtom$SearchActionItem;->PARSER:Lt1/u;
    ...
    sput-object p1, Lcom/android/launcher3/logger/LauncherAtom$SearchActionItem;->PARSER:Lt1/u;
    ...
    iput-object p3, p0, Lcom/android/launcher3/logger/LauncherAtom$SearchActionItem;->title_:Ljava/lang/String;
    ...
    iput-object p3, p0, Lcom/android/launcher3/logger/LauncherAtom$SearchActionItem;->packageName_:Ljava/lang/String;
    :try_end_1
    ...
    check-cast p3, Lcom/android/launcher3/logger/LauncherAtom$SearchActionItem;
    ...
    invoke-virtual {p3}, Lcom/android/launcher3/logger/LauncherAtom$SearchActionItem;->hasPackageName()Z

    move-result v1

    iget-object v2, p3, Lcom/android/launcher3/logger/LauncherAtom$SearchActionItem;->packageName_:Ljava/lang/String;
    ...
    invoke-virtual {p3}, Lcom/android/launcher3/logger/LauncherAtom$SearchActionItem;->hasTitle()Z

    move-result v1

    iget-object v2, p3, Lcom/android/launcher3/logger/LauncherAtom$SearchActionItem;->title_:Ljava/lang/String;
    ...
    iget p2, p3, Lcom/android/launcher3/logger/LauncherAtom$SearchActionItem;->bitField0_:I
    ...
    invoke-direct {p0, v0}, Lcom/android/launcher3/logger/LauncherAtom$SearchActionItem$Builder;-><init>(Lcom/android/launcher3/logger/LauncherAtom$1;)V
