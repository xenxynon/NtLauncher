...
.method static synthetic access$23400()Lcom/android/launcher3/logger/LauncherAtom$PredictedHotseatContainer;
    .locals 1
...
.method static synthetic access$23500(Lcom/android/launcher3/logger/LauncherAtom$PredictedHotseatContainer;I)V
    .locals 0
...
.method protected final dynamicMethod(Lt1/k$i;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :pswitch_0
    sget-object p0, Lcom/android/launcher3/logger/LauncherAtom$PredictedHotseatContainer;->PARSER:Lt1/u;

    if-nez p0, :cond_1

    const-class p0, Lcom/android/launcher3/logger/LauncherAtom$PredictedHotseatContainer;

    monitor-enter p0

    :try_start_0
    sget-object p1, Lcom/android/launcher3/logger/LauncherAtom$PredictedHotseatContainer;->PARSER:Lt1/u;
    ...
    sput-object p1, Lcom/android/launcher3/logger/LauncherAtom$PredictedHotseatContainer;->PARSER:Lt1/u;
    ...
    :cond_3
    iget p3, p0, Lcom/android/launcher3/logger/LauncherAtom$PredictedHotseatContainer;->bitField0_:I

    or-int/lit8 p3, p3, 0x2

    iput p3, p0, Lcom/android/launcher3/logger/LauncherAtom$PredictedHotseatContainer;->bitField0_:I

    invoke-virtual {p2}, Lt1/f;->o()I

    move-result p3

    iput p3, p0, Lcom/android/launcher3/logger/LauncherAtom$PredictedHotseatContainer;->cardinality_:I
    ...
    iput p3, p0, Lcom/android/launcher3/logger/LauncherAtom$PredictedHotseatContainer;->index_:I
    :try_end_1
    ...
    check-cast p3, Lcom/android/launcher3/logger/LauncherAtom$PredictedHotseatContainer;
    ...
    invoke-virtual {p3}, Lcom/android/launcher3/logger/LauncherAtom$PredictedHotseatContainer;->hasIndex()Z

    move-result v1

    iget v2, p3, Lcom/android/launcher3/logger/LauncherAtom$PredictedHotseatContainer;->index_:I
    ...
    invoke-virtual {p3}, Lcom/android/launcher3/logger/LauncherAtom$PredictedHotseatContainer;->hasCardinality()Z

    move-result v1

    iget v2, p3, Lcom/android/launcher3/logger/LauncherAtom$PredictedHotseatContainer;->cardinality_:I
    ...
    iget p1, p0, Lcom/android/launcher3/logger/LauncherAtom$PredictedHotseatContainer;->bitField0_:I

    iget p2, p3, Lcom/android/launcher3/logger/LauncherAtom$PredictedHotseatContainer;->bitField0_:I

    or-int/2addr p1, p2

    iput p1, p0, Lcom/android/launcher3/logger/LauncherAtom$PredictedHotseatContainer;->bitField0_:I
    ...
    invoke-direct {p0, v0}, Lcom/android/launcher3/logger/LauncherAtom$PredictedHotseatContainer$Builder;-><init>(Lcom/android/launcher3/logger/LauncherAtom$1;)V
...
.method public getSerializedSize()I
    ...
    iget v1, p0, Lcom/android/launcher3/logger/LauncherAtom$PredictedHotseatContainer;->bitField0_:I
    ...
    iget v1, p0, Lcom/android/launcher3/logger/LauncherAtom$PredictedHotseatContainer;->index_:I
    ...
    iget v1, p0, Lcom/android/launcher3/logger/LauncherAtom$PredictedHotseatContainer;->cardinality_:I
